...
2. **Hacer un Fork** del repositorio del desafío (crear tu propia copia)
3. **Clonar** tu copia del repositorio a tu computadora
4. **Trabajar** con el código y los datos localmente
...
- El grupo crea una RAMA específica: `rama_grupo_X`
- TODOS los del grupo trabajan en esa rama
...
Repo del Grupo en GitHub (usuario_del_grupo)
        ↓ CREATE BRANCH (rama_grupo_1, rama_grupo_2, etc.)
Rama del Grupo (rama_grupo_X) ← Acá trabaja TODO el grupo
        ↓ CLONE (cada integrante clona en su PC)
Computadora de cada integrante ← Cada uno programa localmente
```

**Roles en el grupo:**
- 👤 **Uno hace el Fork** (crea el repositorio del grupo)
- 👥 **Los tres clonan** el mismo Fork
- 🌿 **Los tres trabajan** en la misma rama (rama_grupo_X)
...
2. Ese mismo integrante **crea una rama** para el grupo (ej: `rama_grupo_1`)
3. **Los TRES integrantes** del grupo:
   - Son agregados como colaboradores al Fork
   - Clonan el mismo repositorio
   - Trabajan en la misma rama del grupo
...
- Sugerencia: El que tenga más experiencia con Git/GitHub
...
3. Te va a aparecer una pantalla: **"Create a new fork"**
   ...
   - **Description:** Poné algo descriptivo: "Desafío ML Salud - Grupo X"
...
### Paso 4: Crear una Rama para el Grupo (Solo quien hizo el Fork)

**Muy importante:** Cada grupo trabaja en su propia rama.

**En el navegador (en tu Fork):**

1. Hacé clic en el botón que dice **"main"** (arriba a la izquierda, donde están los archivos)

2. En el cuadro de texto que dice "Find or create a branch", escribí:
   - `rama_grupo_1` (si son el Grupo 1)
   - `rama_grupo_2` (si son el Grupo 2)
   - `rama_grupo_3` (si son el Grupo 3)
   - etc.

3. Hacé clic en **"Create branch: rama_grupo_X from 'main'"**

4. **¡Listo!** Ya tienen su rama del grupo

**Verificá:**
- El botón que antes decía "main" ahora dice "rama_grupo_X"
- Todos los archivos siguen ahí (se copiaron de main)

---

### Paso 5: Agregar a tus Compañeros como Colaboradores (Solo quien hizo el Fork)
...
7. **Repetí** para cada compañero del grupo
...
### Paso 6: Aceptar la Invitación (Resto del grupo)
...
### Paso 7: Verificar el Fork del Grupo
...
- ✅ Existe la rama del grupo (pueden verla en el botón "main" → lista de ramas)
- ✅ Todos fueron agregados como colaboradores

**Importante:** A partir de ahora, los TRES van a trabajar con:
- El MISMO repositorio (el Fork)
- La MISMA rama (rama_grupo_X)
...
- Trabajar en la MISMA rama (rama_grupo_X)
...
9. Te va a preguntar: **"How are you planning to use this fork?"**
   ...
   - **Si sos colaborador:** Seleccioná **"To contribute to the parent project"** (contribuir al proyecto padre, que es el Fork del grupo)
   - Hacé clic en **"Continue"**

---

### Paso 3.1: Cambiar a la Rama del Grupo (TODOS los integrantes)

**CRÍTICO:** Ahora tenés que cambiarte a la rama donde trabaja el grupo.

1. En GitHub Desktop, arriba vas a ver: **"Current branch: main"**

2. Hacé clic en **"Current branch: main"**

3. En la lista de ramas, buscá: **`rama_grupo_X`** (la que creó tu compañero)

4. Hacé clic en **`rama_grupo_X`**

5. Arriba ahora debería decir: **"Current branch: rama_grupo_X"**

**Verificá:**
- ✅ GitHub Desktop muestra la rama correcta del grupo
- ✅ Los archivos están todos ahí
...
│   └── 01_FE_health_ALUMNO.R          ← Acá vas a crear variables
├── documentacion/
│   ├── 01_guia_instalacion.md
│   ├── 02_guia_estrategia_covid.md
│   └── ...
└── evaluacion/
    └── rubrica_evaluacion.md          ← Cómo te vamos a evaluar
```
...
**3. ANTES de hacer Commit: Fetch (traé cambios de tus compañeros)**
...
**4. Commit (guardá una "foto" de TUS cambios):**
   ...
   - Hacé clic en **"Commit to rama_grupo_X"**
...
**6. Verificá en el navegador:**
   ...
   - Asegurate de estar en la rama correcta (rama_grupo_X)
...
2. Hacé clic en la pestaña **"upstream/main"** o **"Choose a branch"**
...
**Nota:** Esto es avanzado, probablemente no lo necesites para el desafío. Si el profesor actualiza algo importante, te va a avisar.
...
2. Asegurate de estar en la rama del grupo:
   - Arriba a la izquierda, hacé clic en el botón que dice "main"
   - Seleccioná **`rama_grupo_X`**

3. Hacé clic en el botón verde **"Code"**

4. Copiá la URL que aparece (HTTPS):
   - Debería ser: `https://github.com/USUARIO_DEL_GRUPO/health_economics_challenge.git`

5. Abrí la terminal / Git Bash

6. Navegá a la carpeta donde querés guardar el proyecto:
   ```bash
...
8. Entrá a la carpeta del proyecto:
   ```bash
   cd health_economics_challenge
   ```

9. Cambiate a la rama del grupo:
   ```bash
   git checkout rama_grupo_X
   ```
   **Reemplazá X** con el número de tu grupo (1, 2, 3, etc.)

10. Verificá que estés en la rama correcta:
    ```bash
    git branch
    ```
    Debería mostrar: `* rama_grupo_X` (el asterisco indica la rama actual)

11. Verificá que estén todos los archivos:
    ```bash
    ls -la    # Mac/Linux
    dir       # Windows
    ```
...
# Deberías ver:
# origin    https://github.com/TU_USUARIO/health_economics_challenge.git (fetch)
# origin    https://github.com/TU_USUARIO/health_economics_challenge.git (push)
...
```bash
# 1. Asegurate de estar en la rama del grupo
git branch
# Debería mostrar: * rama_grupo_X

# 2. Traé los cambios de tus compañeros
git pull origin rama_grupo_X
```
...
# 4. Subir tus cambios a la rama del grupo
git push origin rama_grupo_X
```
...
# 4. Subí los cambios actualizados a TU repositorio
...
- [ ] ✅ Hice el Fork del repositorio del profesor
- [ ] ✅ Git instalado (ejecutá `git --version` en la terminal)
- [ ] ✅ GitHub Desktop instalado y configurado (o línea de comandos)
- [ ] ✅ Cloné MI FORK del repositorio correctamente
- [ ] ✅ Puedo ver todos los archivos del proyecto
- [ ] ✅ R y RStudio instalados
- [ ] ✅ Librerías de R instaladas sin errores
...
Si todo imprime "✓" → **¡Estás listo para empezar!**
...
### Problema 2: No veo mi Fork en GitHub Desktop

**Solución:**
1. Hacé clic en **"Refresh"** en la lista de repositorios
2. Si no aparece, usá la opción **"URL"** y pegá la URL de tu Fork
...
### Problema 4: Conflictos al hacer Merge/Pull

**Causa:** Modificaste archivos que también cambió el profesor

**Solución Rápida (perderás tus cambios locales):**
```bash
git reset --hard origin/main
git pull origin main
```

**Solución Mejor (conservar tu trabajo):**
```bash
# Guardá tus cambios en un "stash"
git stash

# Descargá los cambios del profesor
git pull upstream main

# Recuperá tus cambios
git stash pop

# Resolvé conflictos manualmente si aparecen
```

---

### Problema 5: RStudio no encuentra los archivos
...
### Problema 6: Error al instalar `lightgbm`
...
### Problema 7: Cloné el repo del profesor por error
...
### Problema 8: No me agregaron como colaborador
...
### Problema 9: Conflictos entre cambios del grupo
...
### Problema 10: Un compañero no puede hacer Push
...
### Problema 11: Estamos trabajando en ramas diferentes por error

**Situación:** Cada uno está en una rama distinta

**Solución:**
1. Todos deben cambiarse a la misma rama:
   - GitHub Desktop: **Current branch** → Seleccionar `rama_grupo_X`
   - CLI: `git checkout rama_grupo_X`

2. Verificar que TODOS estén en la misma rama:
   ```bash
   git branch
   # Debería mostrar: * rama_grupo_X
   ```

3. Si alguien hizo commits en otra rama y los necesitan:
   ```bash
   git checkout rama_grupo_X
   git merge rama_donde_estaban_trabajando
   ```
...
3. ✅ Ese integrante crea rama_grupo_X
4. ✅ Ese integrante agrega a los otros dos como colaboradores
5. ✅ Los otros dos aceptan invitación
   ↓

CONFIGURACIÓN (Cada integrante en su PC)
6. Los TRES clonan el Fork del grupo
7. Los TRES se cambian a rama_grupo_X
8. Los TRES configuran el entorno (R, librerías)
   ↓

TRABAJO ITERATIVO (Ciclo que se repite)
9. 🔄 ANTES DE EMPEZAR: Fetch/Pull (traer cambios del grupo)
10. 📖 Leer documentación y datos
11. 💻 Trabajar en tu parte asignada:
    - Persona A: Variables de eficiencia
    - Persona B: Variables de tendencias
    - Persona C: Variables de contexto
12. 💾 Commit con mensaje descriptivo + tu nombre
13. ⬆️ Push a rama_grupo_X
14. 💬 Avisar al grupo que subiste cambios
    ↓

ANÁLISIS CONJUNTO
15. 🔄 Los tres hacen Pull para tener todo sincronizado
16. ▶️ Ejecutan 0_HEALTH_EXE.R (pipeline completo)
17. 📊 Analizan resultados juntos
18. 🎯 Deciden siguientes mejoras
    ↓

ENTREGA FINAL
19. Preparar informe grupal
20. Verificar que todo esté en rama_grupo_X
21. Hacer commit final con toda la entrega
```
...
```
health_economics_challenge/          ← Tu Fork clonado (SÍ podés modificar)
├── README.md
├── dataset/
├── codigo_base/
...
├── documentacion/
├── evaluacion/
└── mi_trabajo/                      ← Creá esta carpeta para tus experimentos
    ├── notas_experimentos.md
    ├── graficos/
    └── informe_final/
```

**¿Por qué podés modificar tu Fork?**
- Es TU repositorio, no el del profesor
- Podés experimentar libremente
- Tus cambios no afectan al original
- Podés subir todo a GitHub
...
Una vez clonado el repositorio, leé en orden:
...
5. **evaluacion/rubrica_evaluacion.md** - Cómo te vamos a evaluar
...
Antes de empezar a trabajar en el desafío, verificá:
...
- [ ] **El que hizo el Fork** creó la rama del grupo (rama_grupo_X)
...
- [ ] **TODOS** están trabajando en la rama correcta (rama_grupo_X)
...
- [ ] Entendemos el flujo: Fetch → Modificar → Commit → Push
...
**RAMA del GRUPO:**  
Rama: `rama_grupo_X` (X = número de su grupo)
...
- ✅ Modificar el código en tu Fork para tus experimentos
- ✅ Compartir conocimientos con tus compañeros de grupo
...
| **Origin** | Tu repositorio remoto (tu Fork en GitHub) |
...
| **Upstream** | El repositorio original del cual hiciste Fork |
...
| **Fork (Tu copia)** | GitHub en tu cuenta | Tu propia versión del proyecto en la nube |
| **Clone (Tu copia local)** | Tu computadora | Para trabajar offline y programar |

**Flujo completo:**
```
github.com/panchtox/health_economics_challenge (Profesor)
              ↓ FORK
github.com/TU_USUARIO/health_economics_challenge (Tu GitHub)
              ↓ CLONE
C:\...\health_economics_challenge\ (Tu PC)
```
...
**Cualquier duda, preguntá en el campus o en las consultas. ¡No te quedes con dudas!**
